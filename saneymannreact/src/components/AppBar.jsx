          ...
          >
            <div className={classes.MenuItem}>
              <span className={classes.PaddingRight}>
                <span className={classes.Item}>Inicio</span>
              </span>
              <span className={classes.PaddingRight}>
                <span className={classes.Item}>Portafolio</span>
              </span>

              <span className={classes.PaddingRight}>
                <span className={classes.Item}>Galeria</span>
              </span>

              <span>
                <span className={classes.Item}>Contacto</span>
              </span>
            </div>
